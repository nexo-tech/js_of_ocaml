...
test("create: default buffer", function()
  local buf = caml_buffer_create()
  assert_eq(caml_buffer_length(buf), 0)
end)

test("create: buffer with initial size", function()
  local buf = caml_buffer_create(100)
  assert_eq(caml_buffer_length(buf), 0)
...
test("add_char: single character (number)", function()
  local buf = caml_buffer_create()
  caml_buffer_add_char(buf, 65)  -- 'A'
  assert_eq(caml_buffer_length(buf), 1)
  local result = ocaml_string_to_lua(caml_buffer_contents(buf))
  assert_eq(result, "A")
end)

test("add_char: single character (string)", function()
  local buf = caml_buffer_create()
  caml_buffer_add_char(buf, "X")
  assert_eq(caml_buffer_length(buf), 1)
  local result = ocaml_string_to_lua(caml_buffer_contents(buf))
  assert_eq(result, "X")
end)
...
test("add_char: multiple characters", function()
  local buf = caml_buffer_create()
  caml_buffer_add_char(buf, 72)  -- 'H'
  caml_buffer_add_char(buf, 105) -- 'i'
  assert_eq(caml_buffer_length(buf), 2)
  local result = ocaml_string_to_lua(caml_buffer_contents(buf))
  assert_eq(result, "Hi")
end)
...
test("add_string: empty string", function()
  local buf = caml_buffer_create()
  caml_buffer_add_string(buf, "")
  assert_eq(caml_buffer_length(buf), 0)
end)

test("add_string: simple string", function()
  local buf = caml_buffer_create()
  caml_buffer_add_string(buf, "hello")
  assert_eq(caml_buffer_length(buf), 5)
  local result = ocaml_string_to_lua(caml_buffer_contents(buf))
...
test("add_string: multiple strings", function()
  ...
  caml_buffer_add_string(buf, "Hello")
  caml_buffer_add_string(buf, " ")
  caml_buffer_add_string(buf, "World")
  assert_eq(caml_buffer_length(buf), 11)
  local result = ocaml_string_to_lua(caml_buffer_contents(buf))
...
test("add_string: long string", function()
  ...
  caml_buffer_add_string(buf, long_str)
  assert_eq(caml_buffer_length(buf), 300)
  local result = ocaml_string_to_lua(caml_buffer_contents(buf))
...
test("add_substring: full string", function()
  local buf = caml_buffer_create()
  caml_buffer_add_substring(buf, "hello", 0, 5)
  assert_eq(caml_buffer_length(buf), 5)
  local result = ocaml_string_to_lua(caml_buffer_contents(buf))
  assert_eq(result, "hello")
end)
...
test("add_substring: prefix", function()
  local buf = caml_buffer_create()
  caml_buffer_add_substring(buf, "hello", 0, 3)
  assert_eq(caml_buffer_length(buf), 3)
  local result = ocaml_string_to_lua(caml_buffer_contents(buf))
...
test("add_substring: suffix", function()
  local buf = caml_buffer_create()
  caml_buffer_add_substring(buf, "hello", 2, 3)
  assert_eq(caml_buffer_length(buf), 3)
  local result = ocaml_string_to_lua(caml_buffer_contents(buf))
...
test("add_substring: middle", function()
  local buf = caml_buffer_create()
  caml_buffer_add_substring(buf, "hello", 1, 3)
  assert_eq(caml_buffer_length(buf), 3)
  local result = ocaml_string_to_lua(caml_buffer_contents(buf))
...
test("add_substring: single char", function()
  local buf = caml_buffer_create()
  caml_buffer_add_substring(buf, "hello", 0, 1)
  assert_eq(caml_buffer_length(buf), 1)
  local result = ocaml_string_to_lua(caml_buffer_contents(buf))
  assert_eq(result, "h")
end)
...
test("contents: preserves data", function()
  local buf = caml_buffer_create()
  caml_buffer_add_string(buf, "test")
  local result1 = ocaml_string_to_lua(caml_buffer_contents(buf))
  local result2 = ocaml_string_to_lua(caml_buffer_contents(buf))
...
test("length: tracks correctly", function()
  ...
  caml_buffer_add_char(buf, 65)
  assert_eq(caml_buffer_length(buf), 1)

  caml_buffer_add_string(buf, "test")
  assert_eq(caml_buffer_length(buf), 5)

  caml_buffer_add_substring(buf, "hello", 0, 2)
  assert_eq(caml_buffer_length(buf), 7)
end)
...
test("reset: can reuse buffer", function()
  local buf = caml_buffer_create()
  caml_buffer_add_string(buf, "first")
  caml_buffer_reset(buf)
  caml_buffer_add_string(buf, "second")

  assert_eq(caml_buffer_length(buf), 6)
  local result = ocaml_string_to_lua(caml_buffer_contents(buf))
...
test("mixed: char + string + substring", function()
  local buf = caml_buffer_create()
  caml_buffer_add_char(buf, 72)      -- 'H'
  caml_buffer_add_string(buf, "ello")
  caml_buffer_add_char(buf, 32)      -- ' '
  caml_buffer_add_substring(buf, "World!", 0, 5)
...
test("mixed: build sentence", function()
  local buf = caml_buffer_create()
  caml_buffer_add_string(buf, "The")
  caml_buffer_add_char(buf, 32)  -- space
  caml_buffer_add_string(buf, "quick")
  caml_buffer_add_char(buf, 32)
  caml_buffer_add_string(buf, "brown")
  caml_buffer_add_char(buf, 32)
  caml_buffer_add_string(buf, "fox")
...
test("add_printf: simple integer", function()
  local buf = caml_buffer_create()
  caml_buffer_add_printf(buf, "Number: %d", 42)
...
test("add_printf: multiple values", function()
  local buf = caml_buffer_create()
  caml_buffer_add_printf(buf, "x=%d, y=%d", 10, 20)
...
test("add_printf: mixed types", function()
  local buf = caml_buffer_create()
  caml_buffer_add_printf(buf, "%s: %d items at $%.2f", "Order", 5, 12.99)
...
test("add_printf: multiple calls", function()
  local buf = caml_buffer_create()
  caml_buffer_add_printf(buf, "Line %d\n", 1)
  caml_buffer_add_printf(buf, "Line %d\n", 2)
  caml_buffer_add_printf(buf, "Line %d\n", 3)
...
test("performance: many small additions", function()
  ...
  assert_eq(caml_buffer_length(buf), 1000)
end)

test("performance: large string accumulation", function()
  local buf = caml_buffer_create()
  for i = 1, 100 do
    caml_buffer_add_string(buf, "0123456789")
  end
  assert_eq(caml_buffer_length(buf), 1000)
end)
