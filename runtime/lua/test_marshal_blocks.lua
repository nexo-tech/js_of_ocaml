...
test("Simple array roundtrip", function()
  ...
  local m1 = caml_marshal_to_string(t1)
  local r1 = caml_marshal_from_bytes(m1, 0)
  assert_eq(r1[1], 42)
...
test("Nested tables roundtrip", function()
  local t2 = {{1, 2}, {3, 4}}
  local m2 = caml_marshal_to_string(t2)
  local r2 = caml_marshal_from_bytes(m2, 0)
  assert_eq(r2[1][1], 1)
  assert_eq(r2[1][2], 2)
  assert_eq(r2[2][1], 3)
  assert_eq(r2[2][2], 4)
...
test("Mixed types in table", function()
  ...
  local m3 = caml_marshal_to_string(t3)
  local r3 = caml_marshal_from_bytes(m3, 0)
  assert_eq(r3[1], 100)
  assert_eq(r3[2], "test")
  assert_eq(r3[3][1], 5)
  assert_eq(r3[3][2], 6)
...
test("Deeply nested structure", function()
  local t4 = {1, {2, {3, {4, 5}}}}
  local m4 = caml_marshal_to_string(t4)
  local r4 = caml_marshal_from_bytes(m4, 0)
  assert_eq(r4[1], 1)
  assert_eq(r4[2][1], 2)
...
test("Empty table", function()
  local t5 = {}
  local m5 = caml_marshal_to_string(t5)
  local r5 = caml_marshal_from_bytes(m5, 0)
  assert_eq(r5.tag, 0)
  assert_eq(r5.size, 0)
end)
...
test("Table with multiple strings", function()
  ...
  local m6 = caml_marshal_to_string(t6)
  local r6 = caml_marshal_from_bytes(m6, 0)
...
test("Block with explicit tag and size", function()
  ...
  local m7 = caml_marshal_to_string(t7)
  local r7 = caml_marshal_from_bytes(m7, 0)
  assert_eq(r7.tag, 0)
  assert_eq(r7.size, 2)
  assert_eq(r7[1], 10)
  assert_eq(r7[2], 20)
...
test("Complex mixed structure", function()
  ...
  local m8 = caml_marshal_to_string(t8)
  local r8 = caml_marshal_from_bytes(m8, 0)
  assert_eq(r8[1][1], 1)
  assert_eq(r8[1][2], 2)
  assert_eq(r8[1][3], 3)
...
test("Large array (100 elements)", function()
  ...
  local m9 = caml_marshal_to_string(t9)
  local r9 = caml_marshal_from_bytes(m9, 0)
  for i = 1, 100 do
...
test("Array with numbers and nested arrays", function()
  ...
  local m10 = caml_marshal_to_string(t10)
  local r10 = caml_marshal_from_bytes(m10, 0)
  assert_eq(r10[1], 1)
  assert_eq(r10[2][1], 2)
  assert_eq(r10[2][2], 3)
  assert_eq(r10[3], 4)
