...
test("Writer write32s", function()
  local writer = Writer:new()
  writer:write32s(42)
  writer:write32s(-42)
  writer:write32s(2147483647)
  writer:write32s(-2147483648)

  local reader = Reader:new(writer:to_string())
  assert_eq(reader:read32s(), 42, "Positive value")
  assert_eq(reader:read32s(), -42, "Negative value")
  assert_eq(reader:read32s(), 2147483647, "Max positive")
  assert_eq(reader:read32s(), -2147483648, "Min negative")
end)
